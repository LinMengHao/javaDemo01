...
public class RSAUtils {
    ...
    public void token(){
        ...
        String timeStamp="1599727186823";
...
//        verifySign(publicKey, signatureStr, sign);
        verifySign("", signatureStr, "");
    }
    @Test
    public void test(){
        ...
        String token = Sha256Utils.getSHA256(password);
        String signatureStr=token+timestamp+requestId;
        String sign = RSAUtils.sign(privateKey, signatureStr);
        boolean b = verifySign(publicKey, signatureStr, sign);
        System.out.println(b);
    }
    @Test
    public void test2(){
        String signatureStr="b4e10cf1b467e25247400a454c5099971448aeea798921dd94524af25224ba82"+"1599549031812"+"63c0e2a4accc480b9077618d6daa0bcb";
        String sign = RSAUtils.sign(privateKey, signatureStr);
        System.out.println("sign:"+sign);
        boolean b = verifySign(publicKey, "b4e10cf1b467e25247400a454c5099971448aeea798921dd94524af25224ba82159954903181263c0e2a4accc480b9077618d6daa0bcb", "");
        System.out.println(b);
    }
